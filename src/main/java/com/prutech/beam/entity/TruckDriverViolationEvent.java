...
public class TruckDriverViolationEvent implements Serializable {
	...
	public TruckDriverViolationEvent(String truckDriverEventKey, int driverId, int truckId, long timeStamp,
			String timeStampString, double longitude, double latitude, String lastInfraction, long numberOfInfractions,
